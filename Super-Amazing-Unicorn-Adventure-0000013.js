...
function load_media() {
  ...
  Spieler2_1.src =
    "images/Super-Amazing-Unicorn-Adventure-0000013/einhorn2_1.png";

  Spieler2_2 = new Image();
  Spieler2_2.src =
    "images/Super-Amazing-Unicorn-Adventure-0000013/einhorn2_2.png";

  Spieler2_3 = new Image();
  Spieler2_3.src =
    "images/Super-Amazing-Unicorn-Adventure-0000013/einhorn2_3.png";

  Spieler3_1 = new Image();
  Spieler3_1.src =
    "images/Super-Amazing-Unicorn-Adventure-0000013/einhorn3_1.png";

  Spieler3_2 = new Image();
  Spieler3_2.src =
    "images/Super-Amazing-Unicorn-Adventure-0000013/einhorn3_2.png";

  Spieler3_3 = new Image();
  Spieler3_3.src =
    "images/Super-Amazing-Unicorn-Adventure-0000013/einhorn3_3.png";

  Spieler4_1 = new Image();
  Spieler4_1.src =
    "images/Super-Amazing-Unicorn-Adventure-0000013/einhorn4_1.png";

  Spieler4_2 = new Image();
  Spieler4_2.src =
    "images/Super-Amazing-Unicorn-Adventure-0000013/einhorn4_2.png";

  Spieler4_3 = new Image();
  Spieler4_3.src =
    "images/Super-Amazing-Unicorn-Adventure-0000013/einhorn4_3.png";
  ...
  CharakterAuswahl.src =
    "images/Super-Amazing-Unicorn-Adventure-0000013/charakter_auswahl.png";
}
...
Player.prototype.draw = function () {
  if (this.Charaktergewählt == false) {
    ...
    if (this.animation == 1) {
      if (this.aktSpieler == 1) {
        main_ctx.drawImage(
          Spieler1,
          this.drawX,
          this.drawY - abrunden(this.scroll_Y)
        );
    ...
    if (
      mapArray[abrunden((this.drawY + 121) / 120)][
        abrunden((this.drawX + 155) / 160)
      ] == 0 &&
      mapArray[abrunden((this.drawY + 121) / 120)][
        abrunden(this.drawX / 160)
      ] == 0
    ) {
      this.drawY += 5;
    }
...
Player.prototype.check_keys = function () {
  if (
    ...
    this.drawX <= 640 &&
    mapArray[abrunden((this.drawY + 1) / 120)][
      abrunden((this.drawX + 160) / 160)
    ] == 0 &&
    mapArray[abrunden((this.drawY + 119) / 120)][
      abrunden((this.drawX + 160) / 160)
    ] == 0
  ) {
    this.drawX += 5;
...
function key_down(e) {
  ...
  if (key_id == 37) {
    ...
    e.preventDefault();
  } else if (key_id == 49 && player.Charaktergewählt == false) {
    //right key
    player.aktSpieler = 1;
    player.Charaktergewählt = true;
    e.preventDefault();
  } else if (key_id == 50 && player.Charaktergewählt == false) {
    //right key
    player.aktSpieler = 2;
    player.Charaktergewählt = true;
    e.preventDefault();
  } else if (key_id == 51 && player.Charaktergewählt == false) {
    //right key
    player.aktSpieler = 3;
    player.Charaktergewählt = true;
    e.preventDefault();
  } else if (key_id == 52 && player.Charaktergewählt == false) {
    //right key
    player.aktSpieler = 4;
    player.Charaktergewählt = true;
    e.preventDefault();
